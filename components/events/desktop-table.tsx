    ...
    <div>
      <div className="flex items-center justify-between py-4">
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-2 border px-3 py-2 rounded dark:bg-[#484554] dark:border-none">
            <SearchIcon />
            <input
              placeholder="Search..."
          ...
          <div
            className="py-2 px-4 border rounded flex gap-3 cursor-pointer items-center dark:bg-[#484554] dark:border-none"
            onClick={() => {
          ...
          <div
            className="py-2 px-4 border rounded cursor-pointer flex gap-3 items-center dark:bg-[#484554] dark:border-none"
            onClick={() => {
          ...
          <div
            className="py-2 px-4 border rounded cursor-pointer flex gap-3 items-center dark:bg-[#484554] dark:border-none"
            onClick={() => {
              const speakerColumn = table.getColumn("speaker");
              speakerColumn?.toggleSorting(
                speakerColumn.getIsSorted() === "asc"
              );
            }}
          >
            Name
      ...
      <div className="flex items-center justify-between mt-4">
        <div className="flex gap-6">
          ...
          <button
            ...
            className="border p-4 rounded dark:bg-[#484554] dark:border-none !text-white"
          >
